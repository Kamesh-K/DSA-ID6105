...
public: 
    ...
    organism crossover(organism parent2); 
    int calc_fitness(); 
}; 
...
organism organism::crossover(organism par2) 
{ 
...
{ 
    ...
    { 
        ...
        { 
            ...
            organism offspring = parent1.crossover(parent2); 
            new_generation.push_back(offspring);  
        } 
        population = new_generation; 
        cout<<"Generation: "<<generation<<"\t"<<"Best String generated : "<<population[0].chromosome<<"\t"; 
        cout<<"Fitness: "<<population[0].fitness<<"\n"; 
        generation++; 
     } 
    cout<< "Generation: " << generation << "\t"; 
    cout<< "Final String generated: "<< population[0].chromosome <<"\t"; 
    cout<< "Fitness: "<< population[0].fitness << "\n"; 
    time2=omp_get_wtime();
    cout<<"Time taken for the complete process = "<<time2-time1<<endl;
} 
